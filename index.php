...
<body>
	...
	<section id="section-presentacion">
		...
		<a href="productos.php"><button clss="boton-verde" value="Login"><img id="icon-tienda" src="images/tienda.png"/><span id="boton-texto-tienda">Ir a la tienda</span></button></a>
			</section>
